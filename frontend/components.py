...
{posts_html}
    ...
    with tab4:
      ...
      # ---------------------------------------------------------
        ...
        # ---------------------------------------------------------
      # ---------------------------------------------------------
        # THẾ GIỚI 2: DÒNG THỜI GIAN KHUYẾN NGHỊ (FULL ĐỘNG CƠ BATCHING + RADAR TONE ĐEN)
        # ---------------------------------------------------------
        with sub_tab1:
            st.markdown("<br>", unsafe_allow_html=True)
            ...
            def render_short_term_timeline():
                ...
                # ==========================================
                # 1. KÉT SẮT & ĐỘNG CƠ LẤY SỈ (BATCHING)
                # ==========================================
            ...
            # --- DÒNG LỆNH CỰC KỲ QUAN TRỌNG: GỌI HÀM ĐỂ BẬT GIAO DIỆN ---
