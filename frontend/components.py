...
# =========================================================
                    # BỘ NÃO PHÂN TÍCH VÀ TỔNG KẾT TỰ ĐỘNG
                    # =========================================================
                    try:
                        ...
                        if not top_sell_df.empty:
                            ...
                            # Nếu KDH bị bán mạnh, hoặc bất kỳ mã nào đứng chót bảng
                        ...
                        summary_html = f"""
                        <div style='background: #FFFFFF; border: 1px solid #EAECEF; border-radius: 8px; padding: 16px; margin-top: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);'>
                            <div style='font-size: 14px; font-weight: 800; color: #1E2329; margin-bottom: 16px; display: flex; align-items: center; gap: 8px;'><span style='font-size: 18px;'>🤖</span> TỔNG KẾT & PHÂN TÍCH NHANH TỪ HỆ THỐNG</div>
                            
                            <div style='display: flex; gap: 16px; flex-wrap: wrap;'>
                                <div style='flex: 1; min-width: 250px; background: #F0FDFA; border-left: 4px solid #0ECB81; padding: 12px 16px; border-radius: 4px;'>
                                    <div style='font-size: 12px; font-weight: 900; color: #0ECB81; margin-bottom: 8px;'>🔥 TÂM ĐIỂM HÚT TIỀN (GIA TĂNG TỶ TRỌNG)</div>
                                    <ul style='margin: 0; padding-left: 20px; font-size: 13px; color: #1E2329;'>
                                        {top_buy_html if top_buy_html else "<li>Chưa có dữ liệu mua</li>"}
                                    </ul>
                                </div>
                                
                                <div style='flex: 1; min-width: 250px; background: #FEF2F2; border-left: 4px solid #F6465D; padding: 12px 16px; border-radius: 4px;'>
                                    <div style='font-size: 12px; font-weight: 900; color: #F6465D; margin-bottom: 8px;'>ÁP LỰC BÁN RÒNG (GIẢM TỶ TRỌNG)</div>
                                    <ul style='margin: 0; padding-left: 20px; font-size: 13px; color: #1E2329;'>
                                        {top_sell_html if top_sell_html else "<li>Chưa có dữ liệu bán</li>"}
                                    </ul>
                                    {warning_note}
                                </div>
                            </div>
                            
                            <div style='margin-top: 16px; padding-top: 12px; border-top: 1px solid #EAECEF; font-size: 11px; color: #848E9C; font-style: italic; text-align: right;'>
                                📚 Nguồn tham khảo: <b>THAY ĐỔI THÀNH PHẦN CHỈ SỐ Q2/2026 - Dữ liệu chốt ngày 31/03/2026</b>
                            </div>
                        </div>
                        """
